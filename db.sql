...
MySQL - 5.7.32-log : Database - shequzhihuiyanglaopingtai
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`shequzhihuiyanglaopingtai` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `shequzhihuiyanglaopingtai`;
...
insert  into `config`(`id`,`name`,`value`) values (1,'picture1','http://localhost:8080/shequzhihuiyanglaopingtai/upload/1614999756013.jpg'),(2,'picture2','http://localhost:8080/shequzhihuiyanglaopingtai/upload/1614999769770.jpg'),(3,'picture3','http://localhost:8080/shequzhihuiyanglaopingtai/upload/1614999778981.jpg'),(6,'homepage',NULL);
...
insert  into `laoren`(`id`,`laoren_name`,`sex_types`,`laoren_age`,`laoren_phone`,`laoren_photo`,`laoren_id_number`,`laoren_content`,`laoren_time`,`create_time`) values (22,'老人1',1,111,'111','http://localhost:8080/shequzhihuiyanglaopingtai/upload/1618924862044.jpg','111','<p>老人身体情况很好</p>','2021-04-20 21:21:03','2021-04-08 17:34:20'),(23,'老人2',2,222,'222222222','http://localhost:8080/shequzhihuiyanglaopingtai/upload/1618924851123.jpg','2123123123','<p>2222222</p>','2021-04-20 21:20:52',NULL);
...
insert  into `liuyanxinxi`(`id`,`note`,`yhnote`,`note_time`,`reply`,`glreply`,`reply_time`) values (16,'老人1情况很好','张山','2021-04-20 21:27:13','收到老人2情况','admin','2021-04-20 21:28:29'),(17,'老人2情况正常','张文','2021-04-20 21:27:48','收到老人1情况','admin','2021-04-20 21:28:12');
...
insert  into `tijianbingli`(`id`,`laoren_types`,`tijianbingli_name`,`tijianbingli_file`,`tijianbingli_time`,`tijianbingli_content`,`create_time`) values (23,22,'123','http://localhost:8080/shequzhihuiyanglaopingtai/upload/1618925172415.xls','2021-04-20 21:26:13','<p>123</p>',NULL),(24,23,'体检项目2','http://localhost:8080/shequzhihuiyanglaopingtai/upload/1618925163649.doc','2021-04-20 21:26:05','<p><span style=\"color: rgb(96, 98, 102);\">病例情况2</span></p>',NULL);
...
insert  into `token`(`id`,`userid`,`username`,`tablename`,`role`,`token`,`addtime`,`expiratedtime`) values (6,4,'张文','users','用户','zywiewvmudg00gf4kjbhx548zp82w1hb','2021-04-09 15:22:09','2021-04-20 22:27:19'),(7,1,'admin','users','管理员','7ixwwhz0twck89fwdmtsy9w4unz038r6','2021-04-09 15:43:46','2021-04-20 22:27:53'),(8,3,'张山','users','用户','641n7v5avdfrz3xz6tcd7qedqhtl1rsq','2021-04-09 15:49:24','2021-04-20 22:26:41');
...
insert  into `yonghu`(`id`,`username`,`password`,`yonghu_name`,`sex_types`,`yonghu_id_number`,`yonghu_phone`,`yonghu_photo`,`laoren_types`,`create_time`) values (3,'111','111','张山',2,'123123123123123','12312312312','http://localhost:8080/shequzhihuiyanglaopingtai/upload/1618924843783.jpg',22,NULL),(4,'222','222','张文',2,'12312312312312312','12312312312','http://localhost:8080/shequzhihuiyanglaopingtai/upload/1618924837495.jpg',23,NULL);
